    ...
    if(empty($email) || empty($pass)) {
        ...
        if($row = mysqli_fetch_assoc($res)) {
            ...
            if(md5($pass) == $db_password) {
                ...
                $cookie_email_name = "user_email";
                $cookie_email_value = $email;
                // Set cookie to expire in 30 days 
                setcookie($cookie_email_name, $cookie_email_value, time() + (30 * 24 * 60 * 60), "/");

                $cookie_pass_name = "user_pass";
                $cookie_pass_value = $pass;
                // Set cookie to expire in 30 days 
                setcookie($cookie_pass_name, $cookie_pass_value, time() + (30 * 24 * 60 * 60), "/");               
